% function plot_dcut_rela_LZB_zoom
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif nfam == 12
    ...
    SUFFIXhf = strcat('up.hf.time.',num2str(winlenhf),'_',num2str(winlenlf),'.',num2str(lofflf),...
        '.',num2str(ccminlf));
    fname = strcat(rstpath, '/evtloc.all12fam.dcutnodou.',SUFFIXhf);
    hfrelatime = load(fname);
    % 25 cols, format is:
    %   E(043) N(043) E(own) N(own) dist(own) lon lat dep off12 off13 off12sec off13sec date
    %   main_arrival_time  cent_of_win  avecc ccadd1 ccadd2 ccadd3 ccadd4 ampmax ampmin eng normeng famnum
    ...
    SUFFIXlf = strcat('lf.time.',num2str(winlenhf),'_',num2str(winlenlf),'.',num2str(lofflf),...
        '.',num2str(ccminlf));
    fname = strcat(rstpath, '/evtloc.all12fam.dcutnodou.',SUFFIXlf);
    lfrelatime = load(fname);
...
elseif nfam == 12
    SUFFIXhf = strcat('up.hf.time.',num2str(winlenhf),'_',num2str(winlenlf),'.',num2str(lofflf),...
        '.',num2str(ccminlf));
    fname = strcat(rstpath, '/evtloc.KLNBcheck.all12fam.dcutnodou.',SUFFIXhf);
    hfaddcheck = load(fname);
    % 25 cols, format is:
    %   E(043) N(043) E(own) N(own) dist(own) lon lat dep off12 off13 off12sec off13sec date
    %   main_arrival_time  cent_of_win  avecc ccadd1 ccadd2 ccadd3 ccadd4 ampmax ampmin eng normeng famnum
    ...
    SUFFIXlf = strcat('lf.time.',num2str(winlenhf),'_',num2str(winlenlf),'.',num2str(lofflf),...
        '.',num2str(ccminlf));
    fname = strcat(rstpath, '/evtloc.KLNBcheck.all12fam.dcutnodou.',SUFFIXlf);
    lfaddcheck = load(fname);
end
...
%%% save figure to file
if nfam == 11
    print(f.fig,'-dpdf',strcat(rstpath,'/allfam.hflf.alld.dcut.accuhit.',num2str(winlenhf),'_',...
          num2str(winlenlf),'.',num2str(lofflf),'.',num2str(ccminlf),'.rela.pdf'));
elseif nfam == 12
    print(f.fig,'-dpdf',strcat(rstpath,'/all12fam.hflf.alld.dcut.accuhit.',num2str(winlenhf),'_',...
          num2str(winlenlf),'.',num2str(lofflf),'.',num2str(ccminlf),'.rela.pdf'));
end
% keyboard
...
print(f4.fig,'-depsc2',strcat(rstpath,'/dcutreg1strike2005.eps'));
...
print(f6.fig,'-depsc2',strcat(rstpath,'/dcutreg2strike2005.eps'));
...
print(f8.fig,'-depsc2',strcat(rstpath,'/dcutallstrike2004.eps'));
...
print(f9.fig,'-depsc2',strcat(rstpath,'/dcutallstrike2005.eps'));
