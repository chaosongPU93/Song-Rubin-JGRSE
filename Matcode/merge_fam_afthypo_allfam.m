...
%
if dcutflag 
    fidhf = fopen(strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.dcutnodou.',SUFFIXhf),'w+');
    fidlf = fopen(strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.dcutnodou.',SUFFIXlf),'w+');
else
    fidhf = fopen(strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.nodcutnodou.',SUFFIXhf),'w+');
    fidlf = fopen(strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.nodcutnodou.',SUFFIXlf),'w+');
end
...
for ista = 1: nstasnew
    ...
    if dcutflag
        hffname = strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                         'fam.dcut.',SUFFIXhf);
        lffname = strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                         'fam.dcut.',SUFFIXlf);
    else
        hffname = strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                         'fam.nodcut.',SUFFIXhf);
    ...
    %
    if dcutflag
        fidhf = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                      'fam.dcutnodou.',SUFFIXhf),'w+');
        fidlf = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                      'fam.dcutnodou.',SUFFIXlf),'w+');
    else
        fidhf = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                      'fam.nodcutnodou.',SUFFIXhf),'w+');
        fidlf = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                      'fam.nodcutnodou.',SUFFIXlf),'w+');
    end
