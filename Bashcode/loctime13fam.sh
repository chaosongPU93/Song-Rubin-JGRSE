...
# this deals with original 11 fams plus a new fam 006, and 001
...
## LF
cd $rstdir
phafmerge="chat00p.all13fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.lf.sort.all13fam"
...
evtfile="evtloc.all13fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
phafmerge="chat00p.all13fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.up.hf.sort.all13fam"
...
evtfile="evtloc.all13fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
