...
# this deals with original 11 fams plus a new fam 006, and 001, and 158
...
## LF
cd $rstdir
phafmerge="chat00p.all14fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.lf.sort.all14fam"
...
evtfile="evtloc.all14fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
phafmerge="chat00p.all14fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.up.hf.sort.all14fam"
...
evtfile="evtloc.all14fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
