...
## LF
cd $rstdir
phafmerge="chat00p.all12fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.lf.sort.all12fam"
...
evtfile="evtloc.all12fam.lf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
phafmerge="chat00p.all12fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
offfmerge="off.up.hf.sort.all12fam"
...
evtfile="evtloc.all12fam.up.hf.time.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
