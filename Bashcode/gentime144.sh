...
### change several lines accordingly, 2020/05
...
do
    ...
    #echo $off12 $off13
    arr2=`echo "scale=4; (-26 / $sps - $off12) * 1000 + 30000" | bc | cut -d'.' -f1`
    arr3=`echo "scale=4; (10 / $sps - $off13) * 1000 + 30000" | bc | cut -d'.' -f1`
