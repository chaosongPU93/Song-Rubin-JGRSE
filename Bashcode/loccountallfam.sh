...
# LF
cd $rstdir
phafmerge="chat00p.allfam.lf.count.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
rm -f $phafmerge
for phafsingle in `ls chat00p.???.lf.count.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}`
do
    cat $phafsingle >> $phafmerge
done
offfmerge="countori_lf.allfam"
rm -f $offfmerge
...
evtfile="evtloc.allfam.lf.count.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
...
phafmerge="chat00p.allfam.up.hf.count.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
rm -f $phafmerge
...
offfmerge="countori_up.hf.allfam"
rm -f $offfmerge
...
evtfile="evtloc.allfam.up.hf.count.${wlenhf}_${wlenlf}.${lofflf}.${ccminlf}"
